      ...
      <section className="">
        <div className=" px-4 mx-auto max-w-screen-xl text-center pt-16 lg:px-12">
          ...
          <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            <span className="font-semibold font-secondary text-amber-950 uppercase">
              IN PARTNERSHIP WITH
            </span>
          </div>
        </div>
            ...
            <Marquee autoFill={true}>
              ...
              >
                <img
                  ...
                  src="/assets/img/Pedigree-Logo-2007.png"
                  alt="pedigree"
                />
              </a>
              <a
              ...
              >
                <img
                  className="h-30 pr-30"
                  src="/assets/img/Royal-Canin-Logo.png"
                  alt="Royal Canin"
                />
              </a>
              <a
              ...
              >
                <img
                  className="h-30 pr-30"
                  src="/assets/img/Purina-Logo.png"
                  alt="Purina"
                />
              </a>
              <a
              ...
              >
                <img
                  className="h-30 pr-30"
                  src="/assets/img/PAWS-New-Logo.png"
                  alt="PAWS"
                />
              </a>
            </Marquee>
