...
const ProfileImageUpload: FC<ImageUploadPropTypes> = ({ isOpen, onClose, onImageSave }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-end mt-5">
                <button className="px-4 py-2 bg-gray-300 rounded-lg mr-2 hover:bg-gray-400" onClick={onClose}>
                    Cancel
                </button>
                <button 
                    className={`px-4 py-2 rounded-lg text-white ${selectedImage ? "bg-orange-600 hover:bg-orange-700" : "bg-gray-400 cursor-not-allowed"}`}
                    onClick={() => onImageSave(selectedImage || " ",transferImage || null)}
