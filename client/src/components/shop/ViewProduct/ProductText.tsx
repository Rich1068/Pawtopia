...
const ProductText: FC<IProductText> = ({
  ...
  return (
    <>
      <div className="p-6 bg-white rounded-2xl max-lg:mx-auto lg:!mr-auto shadow-lg min-w-full md:min-w-[90%] min-h-auto relative inline-block font-secondary border-2 border-orange-400 pb-20 break-words">
        {/* Product Name */}
